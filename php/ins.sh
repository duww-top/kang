...
###########################################################################3
#开始调用小樱script
wget http://origin.evec.cc/github/kangle/e.sh -O e.sh;sh e.sh /vhs/kangle #安装Kangle
wget http://origin.evec.cc/github/kangle/ep.sh -O ep.sh;sh ep.sh #安装easypanle
#优化php5.2参数
...
#编译安装libevent
wget http://origin.evec.cc/github/kangle/libevent-2.0.21-stable.tar.gz
...
wget http://origin.evec.cc/github/kangle/memcached -O /etc/sysconfig/memcached
